...
[glink target=*new text="最新話" size=20 width="200" x=350 y=430 color=gray font_color=black graphic=more.png clickse=yes.ogg]
...
[chara_new name="c_kyousuke_2" storage="c_kyousuke.png" jname="c_kyousuke_2"]
[chara_new name="c_ponta_2" storage="c_ponta.png" jname="c_ponta_2"]
